...
LocalResource("./applications/img/queuelength.png")
...
LocalResource("./applications/img/multisim - 100 iterations - 1 staff.png")
...
LocalResource("./applications/img/multisim - 100 iterations - 2 staff.png")
...
LocalResource("./applications/img/determinesamplesize.png")
...
LocalResource("./applications/img/samplesize.png")
...
$(PlutoUI.LocalResource("./applications/img/CBoverview.png",:width => 2000))
...
md"""
$(PlutoUI.LocalResource("./applications/img/principle.png",:width => 2000))
"""
...
$(PlutoUI.LocalResource("./applications/img/inoperational.png",:width => 500))

$(PlutoUI.LocalResource("./applications/img/sensorlocation.png",:width => 500))
